			...
			<div className="mx-auto max-w-6xl px-5 md:px-8">
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="mt-5 text-pretty leading-relaxed text-muted-foreground">
						Une question, une commande spéciale ? Écrivez-nous ou passez simplement nous dire
						bonjour.
					</p>
				</div>
				...
				<div className="mt-14 grid gap-12 md:grid-cols-2 md:gap-16">
					...
					{/* Form */}
					<form onSubmit={handleSubmit} className="rounded-2xl bg-card p-7 shadow-sm md:p-8">
						<div className="space-y-5">
							...
							<button
								...
								className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-3 text-base font-medium text-primary-foreground transition-colors hover:bg-accent disabled:opacity-50"
							>
								{sent ? (
									<>
