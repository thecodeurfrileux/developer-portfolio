	...
	return (
		<section id="collections" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
			<Reveal className="mb-14 text-center">
				<p className="text-xs font-light uppercase tracking-[0.3em] text-gold">Nos univers</p>
				...
				{collections.map((item, i) => (
					<Reveal key={item.name} delay={i * 0.1}>
						...
						>
							...
							<h3 className="mt-6 font-serif text-2xl font-light text-ink">{item.name}</h3>
