      ...
      <div className="grid gap-16 md:grid-cols-2 md:gap-20">
        <Reveal>
          ...
          <dl className="mt-10 flex flex-col gap-6 text-sm font-light text-ink">
            <div>
              <dt className="text-xs uppercase tracking-[0.2em] text-stone">
                Adresse
              </dt>
              <dd className="mt-1 text-base">
                12 rue des Floraisons, Pantin, 93500
              </dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-[0.2em] text-stone">
              ...
              <dd className="mt-1 text-base">+33 1 48 00 00 00</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-[0.2em] text-stone">
                Email
              </dt>
              <dd className="mt-1 text-base">bonjour@atelierbloom.fr</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-[0.2em] text-stone">
                Horaires
        ...
        <Reveal delay={0.15}>
          ...
          >
            ...
            <button
              type="submit"
              className="mt-2 self-start bg-forest px-10 py-3.5 text-xs font-light uppercase tracking-[0.2em] text-background transition-colors duration-300 hover:bg-forest/90"
            >
