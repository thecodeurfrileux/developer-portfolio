...
const testimonials = [
	...
	{
		quote:
			"Un vrai professionnel à l’écoute. Tout a été livré en une semaine. Référencement naturelle du site remarquable",
		name: "Sophie",
		role: "fleuriste",
	},
	{
		quote:
			"Grâce à mon nouveau site, j’ai eu plus de 20 nouvelles réservations dès le premier mois. Je recommande les yeux fermés.",
		name: "Karim",
		role: "gérant d’un barber shop",
	},
];
